...
static const u8 max77804k_mask_reg[] = {
	[MAX77804K_LED_INT] = MAX77804K_LED_REG_FLASH_INT_MASK,
	[MAX77804K_TOPSYS_INT] = MAX77804K_PMIC_REG_TOPSYS_INT_MASK,
	[MAX77804K_CHG_INT] = MAX77804K_CHG_REG_CHG_INT_MASK,
	[MAX77804K_MUIC_INT1] = MAX77804K_MUIC_REG_INTMASK1,
	[MAX77804K_MUIC_INT2] = MAX77804K_MUIC_REG_INTMASK2,
	[MAX77804K_MUIC_INT3] = MAX77804K_MUIC_REG_INTMASK3,
};
...
{
	switch (src) {
	case MAX77804K_LED_INT ... MAX77804K_CHG_INT:
		return max77804k->i2c;
	case MAX77804K_MUIC_INT1 ... MAX77804K_MUIC_INT3:
...
static const struct max77804k_irq_data max77804k_irqs[] = {
	DECLARE_IRQ(MAX77804K_LED_IRQ_FLED2_OPEN,	MAX77804K_LED_INT, 1 << 0),
	DECLARE_IRQ(MAX77804K_LED_IRQ_FLED2_SHORT,	MAX77804K_LED_INT, 1 << 1),
	DECLARE_IRQ(MAX77804K_LED_IRQ_FLED1_OPEN,	MAX77804K_LED_INT, 1 << 2),
	DECLARE_IRQ(MAX77804K_LED_IRQ_FLED1_SHORT,	MAX77804K_LED_INT, 1 << 3),
	DECLARE_IRQ(MAX77804K_LED_IRQ_MAX_FLASH,	MAX77804K_LED_INT, 1 << 4),

	DECLARE_IRQ(MAX77804K_TOPSYS_IRQ_T120C_INT,	MAX77804K_TOPSYS_INT, 1 << 0),
	DECLARE_IRQ(MAX77804K_TOPSYS_IRQ_T140C_INT,	MAX77804K_TOPSYS_INT, 1 << 1),
	DECLARE_IRQ(MAX77804K_TOPSYS_IRQLOWSYS_INT,	MAX77804K_TOPSYS_INT, 1 << 3),

	DECLARE_IRQ(MAX77804K_CHG_IRQ_BYP_I,	MAX77804K_CHG_INT, 1 << 0),
	DECLARE_IRQ(MAX77804K_CHG_IRQ_BATP_I,	MAX77804K_CHG_INT, 1 << 2),
	DECLARE_IRQ(MAX77804K_CHG_IRQ_BAT_I,	MAX77804K_CHG_INT, 1 << 3),
	DECLARE_IRQ(MAX77804K_CHG_IRQ_CHG_I,	MAX77804K_CHG_INT, 1 << 4),
#if defined(CONFIG_CHARGER_MAX77804K)
	DECLARE_IRQ(MAX77804K_CHG_IRQ_WCIN_I,	MAX77804K_CHG_INT, 1 << 5),
#endif
	DECLARE_IRQ(MAX77804K_CHG_IRQ_CHGIN_I,	MAX77804K_CHG_INT, 1 << 6),

	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT1_ADC,	MAX77804K_MUIC_INT1, 1 << 0),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT1_ADCLOW,	MAX77804K_MUIC_INT1, 1 << 1),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT1_ADCERR,	MAX77804K_MUIC_INT1, 1 << 2),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT1_ADC1K,	MAX77804K_MUIC_INT1, 1 << 3),

	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_CHGTYP,	MAX77804K_MUIC_INT2, 1 << 0),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_CHGDETREUN,	MAX77804K_MUIC_INT2, 1 << 1),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_DCDTMR,	MAX77804K_MUIC_INT2, 1 << 2),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_DXOVP,	MAX77804K_MUIC_INT2, 1 << 3),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_VBVOLT,	MAX77804K_MUIC_INT2, 1 << 4),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT2_VIDRM,	MAX77804K_MUIC_INT2, 1 << 5),

	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_EOC,	MAX77804K_MUIC_INT3, 1 << 0),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_CGMBC,	MAX77804K_MUIC_INT3, 1 << 1),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_OVP,	MAX77804K_MUIC_INT3, 1 << 2),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_MBCCHGERR,	MAX77804K_MUIC_INT3, 1 << 3),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_CHGENABLED,	MAX77804K_MUIC_INT3, 1 << 4),
	DECLARE_IRQ(MAX77804K_MUIC_IRQ_INT3_BATDET,	MAX77804K_MUIC_INT3, 1 << 5),
};
...
static void max77804k_irq_mask(struct irq_data *data)
{
	...
	if (irq_data->group >= MAX77804K_MUIC_INT1 && irq_data->group <= MAX77804K_MUIC_INT3)
...
static void max77804k_irq_ack(struct irq_data *data)
{
}

static struct irq_chip max77804k_irq_chip = {
	.name			= "max77804k",
	.irq_ack		= max77804k_irq_ack,
...
clear_retry:
	...
	if (irq_src & MAX77804K_IRQSRC_CHG) {
		...
		ret = max77804k_read_reg(max77804k->i2c, MAX77804K_CHG_REG_CHG_INT,
				&irq_reg[MAX77804K_CHG_INT]);
		pr_debug("%s: charger interrupt(0x%02x)\n",
			__func__, irq_reg[MAX77804K_CHG_INT]);
		/* mask chgin to prevent chgin infinite interrupt
		 * chgin is unmasked chgin isr
		 */
		if (irq_reg[MAX77804K_CHG_INT] & max77804k_irqs[MAX77804K_CHG_IRQ_CHGIN_I].mask) {
	...
	if (irq_src & MAX77804K_IRQSRC_TOP) {
		...
		ret = max77804k_read_reg(max77804k->i2c,
				...
				&irq_reg[MAX77804K_TOPSYS_INT]);
		pr_debug("%s: topsys interrupt(0x%02x)\n",
			__func__, irq_reg[MAX77804K_TOPSYS_INT]);
	}
	...
	if (irq_src & MAX77804K_IRQSRC_FLASH) {
		...
		ret = max77804k_read_reg(max77804k->i2c,
				...
				&irq_reg[MAX77804K_LED_INT]);
		pr_debug("%s: led interrupt(0x%02x)\n",
			__func__, irq_reg[MAX77804K_LED_INT]);
	}
	...
	if (irq_src & MAX77804K_IRQSRC_MUIC) {
		...
		MAX77804K_NUM_IRQ_MUIC_REGS,
				&irq_reg[MAX77804K_MUIC_INT1]);
		pr_debug("%s: muic interrupt(0x%02x, 0x%02x, 0x%02x)\n",
			__func__, irq_reg[MAX77804K_MUIC_INT1],
			irq_reg[MAX77804K_MUIC_INT2], irq_reg[MAX77804K_MUIC_INT3]);
	}
...
int max77804k_irq_resume(struct max77804k_dev *max77804k)
{
	...
	dev_dbg(max77804k->dev, "%s: irq_resume ret=%d", __func__, ret);
