...
#define MSM_GCC_GPx_BASE		0xFD8C3450

#define HWIO_GPx_CMD_RCGR_ADDR		((void __iomem *)(virt_mmss_gp1_base + 0x0))	// MMSS_CC_GPx_CMD_RCGR
#define HWIO_GPx_CFG_RCGR_ADDR		((void __iomem *)(virt_mmss_gp1_base + 0x4))	// MMSS_CC_GPx_CFG_RCGR
#define HWIO_GPx_M_REG_ADDR		((void __iomem *)(virt_mmss_gp1_base + 0x8))	// MMSS_CC_GPx_M
#define HWIO_GPx_N_REG_ADDR		((void __iomem *)(virt_mmss_gp1_base + 0xc))	// MMSS_CC_GPx_N
#define HWIO_GPx_D_REG_ADDR		((void __iomem *)(virt_mmss_gp1_base + 0x10))	// MMSS_CC_GPx_D
#define HWIO_CAMSS_GPx_CBCR_ADDR	((void __iomem *)(virt_mmss_gp1_base + 0x24))	// MMSS_CC_CAMSS_GPx_CBCR
...
extern void max77828_vibrator_en(bool en);
#endif
#if defined(CONFIG_MOTOR_DRV_MAX77804K)
extern void max77804k_vibrator_en(bool en);
#endif
#if defined(CONFIG_MOTOR_DRV_MAX77843)
extern void max77843_vibrator_en(bool en);
#endif
